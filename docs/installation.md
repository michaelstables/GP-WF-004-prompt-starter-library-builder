...
This guide walks through importing the Prompt Starter Library Builder into n8n.
...
The workflow should create a dated Google Doc with the finished prompt starter library builder output.
