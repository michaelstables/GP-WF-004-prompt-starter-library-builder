...
Turn rough tasks or prompt ideas into a reusable prompt starter library.
...
- Uses editable n8n inputs for library name, library goal, target user, task or prompt ideas, categories, tag style, and output style
...
Useful prompts disappear into chat history instead of becoming a reusable system.
...
The workflow creates a Google Doc with a prompt library index, categorized prompt entries, variables, use cases, and quality notes.
