...
Open `Set Workflow Inputs` and replace the sample values with your own library name, library goal, target user, task or prompt ideas, categories, tag style, and output style.
